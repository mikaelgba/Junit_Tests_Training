...
public class Cliente {
	...
	// Método que retorna o ID do cliente. @return ID do cliente
	public int getId() {
		return id;
	}
	...
	//Método que retorna o nome do cliente. @return nome do cliente
	...
	//Método que retorna a idade do cliente. @return idade do cliente
	public int getIdade() {
		return idade;
	}
	...
	//Método que retorna o email do cliente.  @return email do cliente
	...
	//Método que retorna o status (Ativo ou Inativo) do cliente.  @return status do cliente
	...
	//Método que retorna a representação textual de um cliente.  @return representação textual de um cliente
	@Override
